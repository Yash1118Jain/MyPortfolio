...
const identityItems = [
  { label: "Current Focus", value: "Machine Learning" },
  { label: "Research", value: "Data Science" },
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl flex-col justify-center gap-12 lg:min-h-[calc(100vh-5rem)] lg:flex-row lg:items-center lg:gap-16">
        ...
        >
          <motion.div
            animate={{ y: [0, -5, 0], opacity: [0.96, 1, 0.96] }}
            transition={{ duration: 7.2, repeat: Infinity, ease: "easeInOut" }}
            className="relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-white/[0.05] p-5 shadow-[0_0_0_1px_rgba(255,255,255,0.03)] backdrop-blur-2xl"
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between border-b border-white/10 pb-4">
                <div className="text-[0.63rem] font-medium uppercase tracking-[0.34em] text-zinc-500">AI Identity</div>
                <div className="rounded-full border border-white/10 bg-white/6 px-2.5 py-1 text-[0.66rem] uppercase tracking-[0.24em] text-zinc-400">
                  Live
                </div>
              </div>
              ...
              <div className="mt-5 space-y-3">
                {identityItems.map((item) => (
                  <div key={item.label} className="rounded-[1rem] border border-white/10 bg-black/10 px-4 py-3">
                    <div className="text-[0.62rem] uppercase tracking-[0.26em] text-zinc-500">{item.label}</div>
              ...
              <div className="mt-5 rounded-[1rem] border border-white/10 bg-white/[0.04] p-4">
                <div className="text-[0.66rem] uppercase tracking-[0.26em] text-zinc-500">Current Signal</div>
                <div className="mt-2 text-sm leading-7 text-zinc-400">
                  Building products that feel precise, useful, and quietly ambitious.
                </div>
              </div>
            </div>
          </motion.div>
